<div id="general" class="ss-tab-pane ss-is-active">
	...
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically generate meta title tag', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically generate meta description tag', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically generate meta robots tag', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically generate Open Graph meta tags for sharing on Facebook and other social networks', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically generate Twitter cards meta tags for sharing on Twitter', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically generate canonical URL to avoid duplicated content', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically generate "rel" links', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically generate XML sitemap to help search engine crawl and index the website content', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically generate "alt" text for images when inserting into post content', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Enable breadcrumbs shortcode for inserting into your template', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically redirect pages if needed', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically add a back link to posts to prevent content from being copied', 'slim-seo' ) ); ?>
		</label>
	</p>
	<p>
		<label>
			...
			<?php echo $this->tooltip( __( 'Automatically generate unified schema graph to help search engines understand the website structure', 'slim-seo' ) ); ?>
		</label>
	</p>
