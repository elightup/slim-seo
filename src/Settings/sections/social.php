...
<div class="ss-field">
	<div class="ss-label">
		<label for="ss-default-linkedin-image"><?php esc_html_e( 'LinkedIn image', 'slim-seo' ); ?></label>
	</div>
	<div class="ss-input">
		<div class="ss-input-group">
			<input type="text" id="ss-default-linkedin-image" name="slim_seo[default_linkedin_image]" value="<?= esc_attr( $data['default_linkedin_image'] ); ?>">
			<button class="ss-select-image button"><?php esc_html_e( 'Select image', 'slim-seo' ); ?></button>
		</div>
		<p class="description">
