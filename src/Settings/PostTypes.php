		...
		$variables = [
			...
			[
				...
				'options' => [
					...
					'author.login'        => __( 'Author username', 'slim-seo-schema' ),
					'author.nickname'     => __( 'Author nickname', 'slim-seo-schema' ),
					'author.email'        => __( 'Author email', 'slim-seo-schema' ),
					'author.url'          => __( 'Author website URL', 'slim-seo-schema' ),
			...
			[
				...
				'options' => [
					...
					'user.login'        => __( 'User username', 'slim-seo-schema' ),
					'user.nickname'     => __( 'User nickname', 'slim-seo-schema' ),
					'user.email'        => __( 'User email', 'slim-seo-schema' ),
					'user.url'          => __( 'User website URL', 'slim-seo-schema' ),
			...
			[
				...
				'options' => [
					...
					'current.time'       => __( 'Current time', 'slim-seo-schema' ),
					'pagination.current' => __( 'Current page (pagination)', 'slim-seo-schema' ),
					'pagination.total'   => __( 'Total number of pages (pagination)', 'slim-seo-schema' ),
