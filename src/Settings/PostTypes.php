	...
	public function get_variables() {
		...
		$variables = [
			...
			[
				...
				'options' => [
					'other.title'     => __( 'Current page title', 'slim-seo-schema' ),
					'other.url'       => __( 'Current page URL', 'slim-seo-schema' ),
					'other.year'      => __( 'Current year', 'slim-seo-schema' ),
					'other.month'     => __( 'Current month', 'slim-seo-schema' ),
					'other.date'      => __( 'Current date', 'slim-seo-schema' ),
					'other.day'       => __( 'Current day of the month', 'slim-seo-schema' ),
					'other.time'      => __( 'Current server time', 'slim-seo-schema' ),
					'other.filename'  => __( 'Filename of your attachment file', 'slim-seo-schema' ),
					'other.page'      => __( 'Page (pagination)', 'slim-seo-schema' ),
					'other.pagetotal' => __( 'Total number of pages.', 'slim-seo-schema' ),
					'other.separator' => __( 'Separator Character', 'slim-seo-schema' ),
				],
			],
		];
