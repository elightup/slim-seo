...
class Loader {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'slim-seo-content-analysis', SLIM_SEO_URL . 'js/content-analysis.js', [ 'wp-element', 'wp-components', 'wp-i18n', 'jquery' ], filemtime( SLIM_SEO_DIR . 'js/content-analysis.js' ), true );
		...
		wp_localize_script( 'slim-seo-content-analysis', 'SSContentAnalysis', $localized_data );
	}
}
